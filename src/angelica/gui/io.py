...
def _metrics_to_dict(m: IterationMetrics) -> dict:
    return {
        ...
        "global_mass_imbalance_kg_per_s": m.global_mass_imbalance_kg_per_s,
        "global_mass_imbalance_rel": m.global_mass_imbalance_rel,
    }
...
def _metrics_from_dict(d: dict) -> IterationMetrics:
    return IterationMetrics(
        ...
        global_mass_imbalance_kg_per_s=float(d.get("global_mass_imbalance_kg_per_s", 0.0)),
        global_mass_imbalance_rel=float(d.get("global_mass_imbalance_rel", 0.0)),
    )
